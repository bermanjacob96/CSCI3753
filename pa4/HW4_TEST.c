 ...
 * Create Date: 11/07/16
 * Modify Date: 11/13/16
 * Description:
 * 	This file contains a program for generating several CPU-bound, IO-bound, and mixed prcocesses
 *  with a specified process scheduler for benchmarking purposes.
 */
...
int main(int argc, char* argv[]) {
    ...
    /* Set number of processes instances */
	...
	if (pid == 0 && process_type == CPU_Bound) {
		if (debug) {
